 ...
 */
@Data
public class ProductToDistributorSettingVo {
    /*分销商id*/
    ...
    @ApiModelProperty(name = "sales_price", notes = "市场价", example = "123")
    ...
    /*是否已关联（checked/unchecked）*/
    @JsonProperty("check_state")
    @JSONField(name = "check_state")
    @ApiModelProperty(name = "check_state", notes = "是否已关联", example = "checked")
