 ...
 */
@Data
@Table(name = "eboss_finace_form_distributor")
public class FinaceSourseDistributorDataVo extends BaseEntity<Long> {
    ...
    @ApiModelProperty(name = "unit_price", notes = "ota销售单价", example = "50")
